...
echo "mv ${WORKSPACE}/equinox/promotion/queue/manual-promote-${DL_LABEL_EQ}.sh ${WORKSPACE}/equinox/promotion/queue/promote-${DL_LABEL_EQ}.sh" >> "${CL_SITE}/deferredSteps.sh"
echo "" >> "${CL_SITE}/deferredSteps.sh"
